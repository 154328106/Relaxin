...
HYBRID_048_OUTPUT ?= $(ROOT_DIR)/build/Artifacts/Relaxin-0.4.8-GroupedGlass-Whitelist-TrueCore.tipa
UPSTREAM_048_APP ?=
HYBRID_049_PACKAGER := $(ROOT_DIR)/DevKit/Helpers/package-hybrid-049.sh
HYBRID_049_OUTPUT ?= $(ROOT_DIR)/build/Artifacts/Relaxin-0.4.9-GroupedGlass-Whitelist-TrueCore.tipa
UPSTREAM_049_APP ?=
